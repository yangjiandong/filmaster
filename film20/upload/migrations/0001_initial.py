...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'UserUploadedImage'
        db.create_table('upload_useruploadedimage', (
        ...
        db.send_create_signal('upload', ['UserUploadedImage'])


    def backwards(self, orm):
        
        # Deleting model 'UserUploadedImage'
        db.delete_table('upload_useruploadedimage')
    ...
    models = {
        ...
        'upload.useruploadedimage': {
            'Meta': {'object_name': 'UserUploadedImage'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
