...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'FBAssociation'
        db.create_table('facebook_connect_fbassociation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('fb_uid', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('is_new', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('is_from_facebook', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('access_token', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
        ))
        db.send_create_signal('facebook_connect', ['FBAssociation'])


    def backwards(self, orm):
        
        # Deleting model 'FBAssociation'
        db.delete_table('facebook_connect_fbassociation')
