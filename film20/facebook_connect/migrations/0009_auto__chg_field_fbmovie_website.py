...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FBMovie.website'
        db.alter_column('facebook_connect_fbmovie', 'website', self.gf('django.db.models.fields.TextField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'FBMovie.website'
        db.alter_column('facebook_connect_fbmovie', 'website', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))
