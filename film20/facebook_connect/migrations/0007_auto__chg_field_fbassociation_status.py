...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FBAssociation.status'
        db.alter_column('facebook_connect_fbassociation', 'status', self.gf('django.db.models.fields.IntegerField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'FBAssociation.status'
        db.alter_column('facebook_connect_fbassociation', 'status', self.gf('django.db.models.fields.IntegerField')())
