...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FBMovie.film'
        db.add_column('facebook_connect_fbmovie', 'film', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Film'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FBMovie.film'
        db.delete_column('facebook_connect_fbmovie', 'film_id')
