...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'FBRequest'
        db.create_table('facebook_connect_fbrequest', (
        ...
        db.send_create_signal('facebook_connect', ['FBRequest'])


    def backwards(self, orm):
        
        # Deleting model 'FBRequest'
        db.delete_table('facebook_connect_fbrequest')
