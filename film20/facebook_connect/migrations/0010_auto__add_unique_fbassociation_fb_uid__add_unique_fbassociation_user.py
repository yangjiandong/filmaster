...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'FBAssociation', fields ['fb_uid']
        db.create_unique('facebook_connect_fbassociation', ['fb_uid'])

        # Adding unique constraint on 'FBAssociation', fields ['user']
        db.create_unique('facebook_connect_fbassociation', ['user_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'FBAssociation', fields ['user']
        db.delete_unique('facebook_connect_fbassociation', ['user_id'])

        # Removing unique constraint on 'FBAssociation', fields ['fb_uid']
        db.delete_unique('facebook_connect_fbassociation', ['fb_uid'])
