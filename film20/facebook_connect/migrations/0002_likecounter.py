...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'LikeCounter'
        db.create_table('facebook_connect_likecounter', (
        ...
        db.send_create_signal('facebook_connect', ['LikeCounter'])

        # Adding unique constraint on 'LikeCounter', fields ['content_type', 'object_id']
        db.create_unique('facebook_connect_likecounter', ['content_type_id', 'object_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'LikeCounter', fields ['content_type', 'object_id']
        db.delete_unique('facebook_connect_likecounter', ['content_type_id', 'object_id'])

        # Deleting model 'LikeCounter'
        db.delete_table('facebook_connect_likecounter')
