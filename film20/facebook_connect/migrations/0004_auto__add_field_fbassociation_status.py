...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FBAssociation.status'
        db.add_column('facebook_connect_fbassociation', 'status', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FBAssociation.status'
        db.delete_column('facebook_connect_fbassociation', 'status')
