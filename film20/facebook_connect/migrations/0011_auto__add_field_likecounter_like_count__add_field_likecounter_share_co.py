...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LikeCounter.like_count'
        db.add_column('facebook_connect_likecounter', 'like_count', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True), keep_default=False)

        # Adding field 'LikeCounter.share_count'
        db.add_column('facebook_connect_likecounter', 'share_count', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True), keep_default=False)

        # Adding field 'LikeCounter.comment_count'
        db.add_column('facebook_connect_likecounter', 'comment_count', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True), keep_default=False)

        # Adding field 'LikeCounter.total_count'
        db.add_column('facebook_connect_likecounter', 'total_count', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True), keep_default=False)

        # Adding field 'LikeCounter.click_count'
        db.add_column('facebook_connect_likecounter', 'click_count', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'LikeCounter.like_count'
        db.delete_column('facebook_connect_likecounter', 'like_count')

        # Deleting field 'LikeCounter.share_count'
        db.delete_column('facebook_connect_likecounter', 'share_count')

        # Deleting field 'LikeCounter.comment_count'
        db.delete_column('facebook_connect_likecounter', 'comment_count')

        # Deleting field 'LikeCounter.total_count'
        db.delete_column('facebook_connect_likecounter', 'total_count')

        # Deleting field 'LikeCounter.click_count'
        db.delete_column('facebook_connect_likecounter', 'click_count')
    ...
    models = {
        ...
        'facebook_connect.fbassociation': {
            ...
            'fb_uid': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '100'}),
        ...
        'facebook_connect.fbrequest': {
            'Meta': {'object_name': 'FBRequest'},
        ...
        'facebook_connect.likecounter': {
            ...
            'click_count': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
            'comment_count': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'like_count': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
            'likes': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'object_id': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'share_count': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
            'shares': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'total_count': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
