...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'FBMovie'
        db.create_table('facebook_connect_fbmovie', (
        ...
        db.send_create_signal('facebook_connect', ['FBMovie'])

        # Adding M2M table for field movies on 'FBUser'
        db.create_table('facebook_connect_fbuser_movies', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('fbuser', models.ForeignKey(orm['facebook_connect.fbuser'], null=False)),
            ('fbmovie', models.ForeignKey(orm['facebook_connect.fbmovie'], null=False))
        ))
        db.create_unique('facebook_connect_fbuser_movies', ['fbuser_id', 'fbmovie_id'])

        # Changing field 'FBUser.link'
        db.alter_column('facebook_connect_fbuser', 'link', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))


    def backwards(self, orm):
        
        # Deleting model 'FBMovie'
        db.delete_table('facebook_connect_fbmovie')

        # Removing M2M table for field movies on 'FBUser'
        db.delete_table('facebook_connect_fbuser_movies')

        # Changing field 'FBUser.link'
        db.alter_column('facebook_connect_fbuser', 'link', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))
