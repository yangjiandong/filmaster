...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'FilmFeature'
        db.create_table('film_features_filmfeature', (
        ...
        db.send_create_signal('film_features', ['FilmFeature'])

        # Adding unique constraint on 'FilmFeature', fields ['type', 'film']
        db.create_unique('film_features_filmfeature', ['type', 'film_id'])

        # Adding model 'FilmFeatureVote'
        db.create_table('film_features_filmfeaturevote', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('type', self.gf('django.db.models.fields.IntegerField')()),
            ('film', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Film'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal('film_features', ['FilmFeatureVote'])

        # Adding unique constraint on 'FilmFeatureVote', fields ['type', 'film', 'user']
        db.create_unique('film_features_filmfeaturevote', ['type', 'film_id', 'user_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'FilmFeatureVote', fields ['type', 'film', 'user']
        db.delete_unique('film_features_filmfeaturevote', ['type', 'film_id', 'user_id'])

        # Removing unique constraint on 'FilmFeature', fields ['type', 'film']
        db.delete_unique('film_features_filmfeature', ['type', 'film_id'])

        # Deleting model 'FilmFeature'
        db.delete_table('film_features_filmfeature')

        # Deleting model 'FilmFeatureVote'
        db.delete_table('film_features_filmfeaturevote')
