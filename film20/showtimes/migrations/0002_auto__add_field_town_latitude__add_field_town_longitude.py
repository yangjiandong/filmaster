...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Town.latitude'
        db.add_column('showtimes_town', 'latitude', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=6, blank=True), keep_default=False)

        # Adding field 'Town.longitude'
        db.add_column('showtimes_town', 'longitude', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=6, blank=True), keep_default=False)
    
    def backwards(self, orm):
        
        # Deleting field 'Town.latitude'
        db.delete_column('showtimes_town', 'latitude')

        # Deleting field 'Town.longitude'
        db.delete_column('showtimes_town', 'longitude')
