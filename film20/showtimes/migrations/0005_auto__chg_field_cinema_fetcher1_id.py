...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Cinema.fetcher1_id'
        db.alter_column('showtimes_cinema', 'fetcher1_id', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Cinema.fetcher1_id'
        raise RuntimeError("Cannot reverse this migration. 'Cinema.fetcher1_id' and its values cannot be restored.")
