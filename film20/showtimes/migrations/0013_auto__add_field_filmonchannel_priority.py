...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FilmOnChannel.priority'
        db.add_column('showtimes_filmonchannel', 'priority', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FilmOnChannel.priority'
        db.delete_column('showtimes_filmonchannel', 'priority')
    ...
    models = {
        ...
        'showtimes.emailtemplate': {
            'LANG': ('django.db.models.fields.CharField', [], {'default': "'pl'", 'max_length': '2'}),
            'Meta': {'object_name': 'EmailTemplate'},
            'active_from': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 5, 8, 12, 23, 55, 823467)'}),
            'active_to': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 5, 15, 12, 23, 55, 823503)'}),
            'content': ('django.db.models.fields.TextField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'type': ('django.db.models.fields.IntegerField', [], {'default': '7'})
        },
        'showtimes.fetcher': {
