...
#        db.delete_table('showtimes_cinema')
        ...
        db.rename_column('showtimes_channel', 'longitude_new', 'longitude')

        # Deleting field 'Channel.town_new'
        db.rename_column('showtimes_channel', 'town_new_id', 'town_id')

        # Deleting field 'Channel.address_new'
        db.rename_column('showtimes_channel', 'address_new', 'address')

        # Deleting field 'Channel.latitude_new'
        db.rename_column('showtimes_channel', 'latitude_new', 'latitude')

        # Deleting field 'Channel.country_new'
        db.rename_column('showtimes_channel', 'country_new_id', 'country_id')

    def backwards(self, orm):
        db.rename_column('showtimes_channel', 'longitude', 'longitude_new')

        # Deleting field 'Channel.town_new'
        db.rename_column('showtimes_channel', 'town_id', 'town_new_id')

        # Deleting field 'Channel.address_new'
        db.rename_column('showtimes_channel', 'address', 'address_new')

        # Deleting field 'Channel.latitude_new'
        db.rename_column('showtimes_channel', 'latitude', 'latitude_new')

        # Deleting field 'Channel.country_new'
        db.rename_column('showtimes_channel', 'country_id', 'country_new_id')
