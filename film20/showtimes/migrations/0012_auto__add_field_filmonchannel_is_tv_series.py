...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FilmOnChannel.is_tv_series'
        db.add_column('showtimes_filmonchannel', 'is_tv_series', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FilmOnChannel.is_tv_series'
        db.delete_column('showtimes_filmonchannel', 'is_tv_series')
    ...
    models = {
        ...
        'showtimes.emailtemplate': {
            ...
            'active_from': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 3, 27, 11, 22, 55, 782163)'}),
            'active_to': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 4, 3, 11, 22, 55, 782202)'}),
