...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Town', fields ['country', 'name']
        db.create_unique('showtimes_town', ['country_id', 'name'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Town', fields ['country', 'name']
        db.delete_unique('showtimes_town', ['country_id', 'name'])
