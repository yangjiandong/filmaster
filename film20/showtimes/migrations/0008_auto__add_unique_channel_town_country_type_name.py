...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Channel', fields ['town', 'country', 'type', 'name']
        db.create_unique('showtimes_channel', ['town_id', 'country_id', 'type', 'name'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Channel', fields ['town', 'country', 'type', 'name']
        db.delete_unique('showtimes_channel', ['town_id', 'country_id', 'type', 'name'])
