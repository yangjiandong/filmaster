...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FilmOnChannel.data'
        db.add_column('showtimes_filmonchannel', 'data', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FilmOnChannel.data'
        db.delete_column('showtimes_filmonchannel', 'data')
    ...
    models = {
        ...
        'showtimes.emailtemplate': {
            ...
            'active_from': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 3, 6, 16, 33, 12, 689731)'}),
            'active_to': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 3, 13, 16, 33, 12, 689796)'}),
