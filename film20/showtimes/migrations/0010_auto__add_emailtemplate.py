...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('showtimes_emailtemplate', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('LANG', self.gf('django.db.models.fields.CharField')(default='pl', max_length=2)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('content', self.gf('django.db.models.fields.TextField')()),
            ('type', self.gf('django.db.models.fields.IntegerField')(default=7)),
            ('active_from', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2012, 1, 25, 18, 44, 32, 71690))),
            ('active_to', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2012, 2, 1, 18, 44, 32, 71732))),
        ))
        db.send_create_signal('showtimes', ['EmailTemplate'])


    def backwards(self, orm):
        
        # Deleting model 'EmailTemplate'
        db.delete_table('showtimes_emailtemplate')
    ...
    models = {
        ...
        'showtimes.emailtemplate': {
            ...
            'active_from': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 1, 25, 18, 44, 32, 71690)'}),
            'active_to': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 2, 1, 18, 44, 32, 71732)'}),
