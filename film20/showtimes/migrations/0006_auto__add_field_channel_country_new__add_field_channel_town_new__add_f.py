...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Channel.country_new'
        db.add_column('showtimes_channel', 'country_new', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['showtimes.Country'], null=True), keep_default=False)

        # Adding field 'Channel.town_new'
        db.add_column('showtimes_channel', 'town_new', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['showtimes.Town'], null=True, blank=True), keep_default=False)

        # Adding field 'Channel.address_new'
        db.add_column('showtimes_channel', 'address_new', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True), keep_default=False)

        # Adding field 'Channel.latitude_new'
        db.add_column('showtimes_channel', 'latitude_new', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=6, blank=True), keep_default=False)

        # Adding field 'Channel.longitude_new'
        db.add_column('showtimes_channel', 'longitude_new', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=6, blank=True), keep_default=False)

        for c in orm.TVChannel.objects.all():
            c.country_new = c.country
            c.save()

        for c in orm.Cinema.objects.all():
            c.country_new = c.town.country
            c.town_new = c.town
            c.address_new = c.address
            c.latitude_new = c.latitude
            c.longitude_new = c.longitude
            c.save()

    def backwards(self, orm):
        
        # Deleting field 'Channel.country_new'
        db.delete_column('showtimes_channel', 'country_new_id')

        # Deleting field 'Channel.town_new'
        db.delete_column('showtimes_channel', 'town_new_id')

        # Deleting field 'Channel.address_new'
        db.delete_column('showtimes_channel', 'address_new')

        # Deleting field 'Channel.latitude_new'
        db.delete_column('showtimes_channel', 'latitude_new')

        # Deleting field 'Channel.longitude_new'
        db.delete_column('showtimes_channel', 'longitude_new')
    ...
    models = {
        ...
        'showtimes.channel': {
            ...
            'address_new': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'blank': 'True'}),
            'country_new': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['showtimes.Country']", 'null': 'True'}),
            'icon': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'is_default': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'last_screening_time': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'latitude_new': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '6', 'blank': 'True'}),
            'longitude_new': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '6', 'blank': 'True'}),
            ...
            'town_new': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['showtimes.Town']", 'null': 'True', 'blank': 'True'}),
            'type': ('django.db.models.fields.IntegerField', [], {})
        },
        'showtimes.cinema': {
            ...
            'fetcher1_id': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True'}),
