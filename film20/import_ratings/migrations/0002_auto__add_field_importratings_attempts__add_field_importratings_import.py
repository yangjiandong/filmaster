...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ImportRatings.attempts'
        db.add_column('import_ratings_importratings', 'attempts', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'ImportRatings.import_status'
        db.add_column('import_ratings_importratings', 'import_status', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'ImportRatings.import_error_message'
        db.add_column('import_ratings_importratings', 'import_error_message', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ImportRatings.attempts'
        db.delete_column('import_ratings_importratings', 'attempts')

        # Deleting field 'ImportRatings.import_status'
        db.delete_column('import_ratings_importratings', 'import_status')

        # Deleting field 'ImportRatings.import_error_message'
        db.delete_column('import_ratings_importratings', 'import_error_message')
    ...
    models = {
        ...
        'import_ratings.importratings': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'import_error_message': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'import_status': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
