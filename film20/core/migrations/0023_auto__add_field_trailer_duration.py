...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Trailer.duration'
        db.add_column('core_trailer', 'duration', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Trailer.duration'
        db.delete_column('core_trailer', 'duration')
    ...
    models = {
        ...
        'core.film': {
            ...
            'completion_year': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            ...
            'is_tv_series': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        'core.filmcountryinfo': {
            'Meta': {'unique_together': "(('film', 'country_code'),)", 'object_name': 'FilmCountryInfo'},
        ...
        'core.profile': {
            ...
            'twitter_access_token': ('django.db.models.fields.CharField', [], {'max_length': '256', 'null': 'True', 'blank': 'True'}),
        ...
        'core.trailer': {
            'LANG': ('django.db.models.fields.CharField', [], {'max_length': '2', 'null': 'True', 'blank': 'True'}),
            'Meta': {'unique_together': "(('object', 'url', 'LANG'),)", 'object_name': 'Trailer'},
            'added_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'date_added': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            ...
            'object': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Object']"}),
            'rejection_reason': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'thumb': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True', 'blank': 'True'}),
            'url': ('django.db.models.fields.URLField', [], {'max_length': '2048'})
        },
        'core.trailertoremove': {
            'Meta': {'object_name': 'TrailerToRemove'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'moderation_status': ('django.db.models.fields.IntegerField', [], {'default': '-1'}),
            'moderation_status_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'moderation_status_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'trailertoremove_moderated_objects'", 'null': 'True', 'to': "orm['auth.User']"}),
            'rejection_reason': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'trailer': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'remove_link'", 'to': "orm['core.Trailer']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        },
