...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Profile.twitter_access_token'
        db.alter_column('core_profile', 'twitter_access_token', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))


    def backwards(self, orm):
        
        # Changing field 'Profile.twitter_access_token'
        db.alter_column('core_profile', 'twitter_access_token', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))
