...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Film.completion_year'
        db.add_column('core_film', 'completion_year', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Film.completion_year'
        db.delete_column('core_film', 'completion_year')
