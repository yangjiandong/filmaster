...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('core', ['Poster'])

        # Adding unique constraint on 'Poster', fields ['object', 'image']
        db.create_unique('core_poster', ['object_id', 'image'])
        ...
        db.create_table('core_trailer', (
            ...
            ('added_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
            ('date_added', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('url', self.gf('django.db.models.fields.files.ImageField')(max_length=256, null=True, blank=True)),
        ))
        db.send_create_signal('core', ['Trailer'])

        # Adding unique constraint on 'Trailer', fields ['object', 'url']
        db.create_unique('core_trailer', ['object_id', 'url'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Trailer', fields ['object', 'url']
        db.delete_unique('core_trailer', ['object_id', 'url'])

        # Removing unique constraint on 'Poster', fields ['object', 'image']
        db.delete_unique('core_poster', ['object_id', 'image'])

        # Deleting model 'Poster'
        db.delete_table('core_poster')
    ...
    models = {
        ...
        'core.trailer': {
            ...
            'is_main': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'object': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Object']"}),
            'url': ('django.db.models.fields.files.ImageField', [], {'max_length': '256', 'null': 'True', 'blank': 'True'})
        },
