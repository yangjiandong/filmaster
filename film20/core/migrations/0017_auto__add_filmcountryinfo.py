...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'FilmCountryInfo'
        db.create_table('core_filmcountryinfo', (
        ...
        db.send_create_signal('core', ['FilmCountryInfo'])


    def backwards(self, orm):
        
        # Deleting model 'FilmCountryInfo'
        db.delete_table('core_filmcountryinfo')
    ...
    models = {
        ...
        'core.filmcountryinfo': {
            'Meta': {'object_name': 'FilmCountryInfo'},
