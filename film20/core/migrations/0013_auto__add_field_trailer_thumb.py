...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Trailer.thumb'
        db.add_column('core_trailer', 'thumb', self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Trailer.thumb'
        db.delete_column('core_trailer', 'thumb')
