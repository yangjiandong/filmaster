...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profile.current_goal'
        db.add_column('core_profile', 'current_goal', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)
        orm.Profile.objects.filter(user__is_active=True, recommendations_status__in=[1, 3]).update(current_goal=2)

    def backwards(self, orm):
        
        # Deleting field 'Profile.current_goal'
        db.delete_column('core_profile', 'current_goal')
