...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Film.netflix_id'
        db.add_column('core_film', 'netflix_id', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Film.netflix_id'
        db.delete_column('core_film', 'netflix_id')
