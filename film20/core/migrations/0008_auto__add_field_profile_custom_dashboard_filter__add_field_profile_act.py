...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profile.custom_dashboard_filter'
        db.add_column('core_profile', 'custom_dashboard_filter', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Profile.activities_on_dashboard'
        db.add_column('core_profile', 'activities_on_dashboard', self.gf('django.db.models.fields.CommaSeparatedIntegerField')(max_length=255, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Profile.custom_dashboard_filter'
        db.delete_column('core_profile', 'custom_dashboard_filter')

        # Deleting field 'Profile.activities_on_dashboard'
        db.delete_column('core_profile', 'activities_on_dashboard')
