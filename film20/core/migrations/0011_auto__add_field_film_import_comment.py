...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Film.import_comment'
        db.add_column('core_film', 'import_comment', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Film.import_comment'
        db.delete_column('core_film', 'import_comment')
