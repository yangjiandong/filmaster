...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'FilmCountryInfo', fields ['country_code', 'film']
        db.create_unique('core_filmcountryinfo', ['country_code', 'film_id'])

        # Adding field 'Film.netflix_instant'
        db.add_column('core_film', 'netflix_instant', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Removing unique constraint on 'FilmCountryInfo', fields ['country_code', 'film']
        db.delete_unique('core_filmcountryinfo', ['country_code', 'film_id'])

        # Deleting field 'Film.netflix_instant'
        db.delete_column('core_film', 'netflix_instant')
