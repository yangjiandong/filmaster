...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'TrailerToRemove'
        db.create_table('core_trailertoremove', (
            ...
            ('moderation_status_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='trailertoremove_moderated_objects', null=True, to=orm['auth.User'])),
            ('rejection_reason', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('trailer', self.gf('django.db.models.fields.related.ForeignKey')(related_name='remove_link', to=orm['core.Trailer'])),
        ))
        db.send_create_signal('core', ['TrailerToRemove'])


    def backwards(self, orm):
        
        # Deleting model 'TrailerToRemove'
        db.delete_table('core_trailertoremove')
