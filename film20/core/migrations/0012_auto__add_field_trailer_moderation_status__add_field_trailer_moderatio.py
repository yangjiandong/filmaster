...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Trailer.moderation_status'
        db.add_column('core_trailer', 'moderation_status', self.gf('django.db.models.fields.IntegerField')(default=-1), keep_default=False)

        # Adding field 'Trailer.moderation_status_at'
        db.add_column('core_trailer', 'moderation_status_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Trailer.moderation_status_by'
        db.add_column('core_trailer', 'moderation_status_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='trailer_moderated_objects', null=True, to=orm['auth.User']), keep_default=False)

        # Adding field 'Trailer.rejection_reason'
        db.add_column('core_trailer', 'rejection_reason', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Changing field 'Trailer.url'
        db.alter_column('core_trailer', 'url', self.gf('django.db.models.fields.URLField')(default='', max_length=2048))


    def backwards(self, orm):
        
        # Deleting field 'Trailer.moderation_status'
        db.delete_column('core_trailer', 'moderation_status')

        # Deleting field 'Trailer.moderation_status_at'
        db.delete_column('core_trailer', 'moderation_status_at')

        # Deleting field 'Trailer.moderation_status_by'
        db.delete_column('core_trailer', 'moderation_status_by_id')

        # Deleting field 'Trailer.rejection_reason'
        db.delete_column('core_trailer', 'rejection_reason')

        # Changing field 'Trailer.url'
        db.alter_column('core_trailer', 'url', self.gf('django.db.models.fields.files.ImageField')(max_length=256, null=True))
    ...
    models = {
        ...
        'core.filmranking': {
            ...
            'actor': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Person']", 'null': 'True'}),
        ...
        'core.poster': {
            ...
            'Meta': {'unique_together': "(('object', 'image'),)", 'object_name': 'Poster'},
        ...
        'core.profile': {
            ...
            'activities_on_dashboard': ('django.db.models.fields.CommaSeparatedIntegerField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            ...
            'current_goal': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'custom_dashboard_filter': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        'core.trailer': {
            'LANG': ('django.db.models.fields.CharField', [], {'max_length': '2', 'null': 'True', 'blank': 'True'}),
            'Meta': {'unique_together': "(('object', 'url'),)", 'object_name': 'Trailer'},
            'added_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'date_added': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_main': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'moderation_status': ('django.db.models.fields.IntegerField', [], {'default': '-1'}),
            'moderation_status_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'moderation_status_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'trailer_moderated_objects'", 'null': 'True', 'to': "orm['auth.User']"}),
            'object': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Object']"}),
            'rejection_reason': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
