...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FilmRanking.actor'
        db.add_column('core_filmranking', 'actor', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Person'], null=True), keep_default=False)

        # Adding field 'FilmRanking.updated_at'
        db.add_column('core_filmranking', 'updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FilmRanking.actor'
        db.delete_column('core_filmranking', 'actor_id')

        # Deleting field 'FilmRanking.updated_at'
        db.delete_column('core_filmranking', 'updated_at')
