...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Film.is_tv_series'
        db.add_column('core_film', 'is_tv_series', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Film.is_tv_series'
        db.delete_column('core_film', 'is_tv_series')
