...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'RecomError', fields ['date']
        db.create_unique('core_recomerror', ['date'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'RecomError', fields ['date']
        db.delete_unique('core_recomerror', ['date'])
