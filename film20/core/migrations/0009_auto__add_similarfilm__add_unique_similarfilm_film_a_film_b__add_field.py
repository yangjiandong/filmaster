...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SimilarFilm'
        db.create_table('core_similarfilm', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('film_a', self.gf('django.db.models.fields.related.ForeignKey')(related_name='similar_film_a', to=orm['core.Film'])),
            ('film_b', self.gf('django.db.models.fields.related.ForeignKey')(related_name='similar_film_b', to=orm['core.Film'])),
            ('number_of_votes', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('core', ['SimilarFilm'])

        # Adding M2M table for field votes on 'SimilarFilm'
        db.create_table('core_similarfilm_votes', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('similarfilm', models.ForeignKey(orm['core.similarfilm'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('core_similarfilm_votes', ['similarfilm_id', 'user_id'])

        # Adding unique constraint on 'SimilarFilm', fields ['film_a', 'film_b']
        db.create_unique('core_similarfilm', ['film_a_id', 'film_b_id'])

        # Adding field 'Person.import_comment'
        # db.add_column('core_person', 'import_comment', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Removing unique constraint on 'SimilarFilm', fields ['film_a', 'film_b']
        db.delete_unique('core_similarfilm', ['film_a_id', 'film_b_id'])

        # Deleting model 'SimilarFilm'
        db.delete_table('core_similarfilm')

        # Removing M2M table for field votes on 'SimilarFilm'
        db.delete_table('core_similarfilm_votes')

        # Deleting field 'Person.import_comment'
        #db.delete_column('core_person', 'import_comment')
    ...
    models = {
        ...
        'core.similarfilm': {
            'Meta': {'unique_together': "(('film_a', 'film_b'),)", 'object_name': 'SimilarFilm'},
