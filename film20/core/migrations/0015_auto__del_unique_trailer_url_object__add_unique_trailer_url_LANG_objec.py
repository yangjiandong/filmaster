...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'Trailer', fields ['url', 'object']
        db.delete_unique('core_trailer', ['url', 'object_id'])

        # Adding unique constraint on 'Trailer', fields ['url', 'LANG', 'object']
        db.create_unique('core_trailer', ['url', 'LANG', 'object_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Trailer', fields ['url', 'LANG', 'object']
        db.delete_unique('core_trailer', ['url', 'LANG', 'object_id'])

        # Adding unique constraint on 'Trailer', fields ['url', 'object']
        db.create_unique('core_trailer', ['url', 'object_id'])
