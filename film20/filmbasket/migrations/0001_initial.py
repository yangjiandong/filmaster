...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('filmbasket_basketitem', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('film', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Film'])),
            ('owned', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('wishlist', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('filmbasket', ['BasketItem'])

        # Adding unique constraint on 'BasketItem', fields ['user', 'film']
        db.create_unique('filmbasket_basketitem', ['user_id', 'film_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'BasketItem', fields ['user', 'film']
        db.delete_unique('filmbasket_basketitem', ['user_id', 'film_id'])

        # Deleting model 'BasketItem'
        db.delete_table('filmbasket_basketitem')
    ...
    models = {
        ...
        'filmbasket.basketitem': {
            'Meta': {'unique_together': "(('user', 'film'),)", 'object_name': 'BasketItem'},
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'film': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Film']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'owned': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'wishlist': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'})
        },
        'followers.followers': {
