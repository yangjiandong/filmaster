...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        db.execute("""update useractivity_useractivity set slug='/profil/' || username || '/link/' || link_id || '/', subdomain=NULL where activity_type=5 and "LANG"='pl'""")
        db.execute("""update useractivity_useractivity set slug='/profile/' || username || '/link/' || link_id || '/', subdomain=NULL where activity_type=5 and "LANG"='en'""")
