...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        with transaction():
            db.execute("drop index one_activity_per_checkin")

        with transaction():
            db.execute("""CREATE UNIQUE INDEX "one_activity_per_checkin_and_lang" 
                    on "useractivity_useractivity"("checkin_id", "LANG") 
