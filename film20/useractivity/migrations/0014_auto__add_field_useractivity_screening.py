...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserActivity.screening'
        db.add_column('useractivity_useractivity', 'screening', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='activity_screening', null=True, to=orm['showtimes.Screening']), keep_default=False)

    def backwards(self, orm):
        
        # Deleting field 'UserActivity.screening'
        db.delete_column('useractivity_useractivity', 'screening_id')
