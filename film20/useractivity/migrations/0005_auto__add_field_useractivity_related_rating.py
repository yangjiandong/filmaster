...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserActivity.related_rating'
        db.add_column('useractivity_useractivity', 'related_rating', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='activity_rating', null=True, to=orm['core.Rating']), keep_default=False)

    def backwards(self, orm):
        
        # Deleting field 'UserActivity.related_rating'
        db.delete_column('useractivity_useractivity', 'related_rating_id')
