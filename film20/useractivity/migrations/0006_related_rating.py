...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        db.execute("""update useractivity_useractivity a set related_rating_id=(select id from core_rating where type=1 and parent_id=a.film_id and user_id=a.user_id) where activity_type=4""")
