...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserActivity.trailer'
        db.add_column('useractivity_useractivity', 'trailer', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='activity_trailer', null=True, to=orm['core.Trailer']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserActivity.trailer'
        db.delete_column('useractivity_useractivity', 'trailer_id')
