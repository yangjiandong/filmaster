...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserActivity.hidden'
        db.add_column('useractivity_useractivity', 'hidden', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'UserActivity.parent'
        db.add_column('useractivity_useractivity', 'parent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['useractivity.UserActivity'], null=True, blank=True), keep_default=False)

        # Adding field 'UserActivity.hidden_activities'
        db.add_column('useractivity_useractivity', 'hidden_activities', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserActivity.hidden'
        db.delete_column('useractivity_useractivity', 'hidden')

        # Deleting field 'UserActivity.parent'
        db.delete_column('useractivity_useractivity', 'parent_id')

        # Deleting field 'UserActivity.hidden_activities'
        db.delete_column('useractivity_useractivity', 'hidden_activities')
    ...
    models = {
        ...
        'externallink.externallink': {
            'LANG': ('django.db.models.fields.CharField', [], {'default': "'en'", 'max_length': '2'}),
            'Meta': {'unique_together': "(('film', 'url', 'LANG'), ('person', 'url', 'LANG'))", 'object_name': 'ExternalLink', '_ormbases': ['core.Object']},
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
        ...
        'useractivity.useractivity': {
            ...
            'hidden_activities': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_first_post': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['useractivity.UserActivity']", 'null': 'True', 'blank': 'True'}),
            ...
            'rating': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'related_rating': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'activity_rating'", 'null': 'True', 'to': "orm['core.Rating']"}),
        ...
        'useractivity.watching': {
            ...
            'activity': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['useractivity.UserActivity']", 'null': 'True'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_auto': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'is_observed': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'object': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['core.Object']", 'null': 'True'}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
