...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        a=''
        # Adding field 'UserActivity.demot'
        #db.add_column('useractivity_useractivity', 'demot', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='activity_demot', null=True, to=orm['demots.Demot']), keep_default=False)


    def backwards(self, orm):
        a=''
        # Deleting field 'UserActivity.demot'
        #db.delete_column('useractivity_useractivity', 'demot_id')
    ...
    models = {
        ...
        'demots.demot': {
            ...
            'based_on': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['demots.Demot']", 'null': 'True', 'blank': 'True'}),
        ...
        'useractivity.useractivity': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'demot': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'activity_demot'", 'null': 'True', 'to': "orm['demots.Demot']"}),
