...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('useractivity_useractivity', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('activity_type', self.gf('django.db.models.fields.IntegerField')()),
            ('status', self.gf('django.db.models.fields.IntegerField')(default=1)),
            ('permalink', self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='user_activity', to=orm['auth.User'])),
            ...
            ('watching_object', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='watching_activity', null=True, to=orm['core.Object'])),
            ('post', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='blog_activity', null=True, to=orm['blog.Post'])),
            ('short_review', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='short_review_activity', null=True, to=orm['core.ShortReview'])),
            ('comment', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='comment_activity', null=True, to=orm['threadedcomments.ThreadedComment'])),
            ('link', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='link_activity', null=True, to=orm['externallink.ExternalLink'])),
            ('film', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='activity_film', null=True, to=orm['core.Film'])),
            ('person', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='activity_person', null=True, to=orm['core.Person'])),
            ('checkin', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='activity_checkin', null=True, to=orm['showtimes.ScreeningCheckIn'])),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('content', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('film_title', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('film_permalink', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('subdomain', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True)),
            ('slug', self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True)),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
            ('url_kind', self.gf('django.db.models.fields.IntegerField')(default=1, null=True, blank=True)),
            ('video_thumb', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('spoilers', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('is_first_post', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('number_of_comments', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True)),
            ('channel_name', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ('channel', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['showtimes.Channel'], null=True, blank=True)),
            ('checkin_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ...
        db.send_create_signal('useractivity', ['UserActivity'])

        # Adding model 'Watching'
        db.create_table('useractivity_watching', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('object', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Object'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='watching_user', to=orm['auth.User'])),
            ('watching_type', self.gf('django.db.models.fields.IntegerField')()),
            ('is_observed', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('is_auto', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('useractivity', ['Watching'])


    def backwards(self, orm):
        
        # Deleting model 'UserActivity'
        db.delete_table('useractivity_useractivity')

        # Deleting model 'Watching'
        db.delete_table('useractivity_watching')
