...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Watching.activity'
        db.add_column('useractivity_watching', 'activity', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['useractivity.UserActivity'], null=True), keep_default=False)

        # Changing field 'Watching.object'
        db.alter_column('useractivity_watching', 'object_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Object'], null=True))


    def backwards(self, orm):
        
        # Deleting field 'Watching.activity'
        db.delete_column('useractivity_watching', 'activity_id')

        # User chose to not deal with backwards NULL issues for 'Watching.object'
        raise RuntimeError("Cannot reverse this migration. 'Watching.object' and its values cannot be restored.")
