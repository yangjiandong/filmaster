...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserActivity.object_title'
        db.add_column('useractivity_useractivity', 'object_title', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'UserActivity.object_title'
        db.delete_column('useractivity_useractivity', 'object_title')
