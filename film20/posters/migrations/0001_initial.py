...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ModeratedPhoto'
        db.create_table('posters_moderatedphoto', (
            ...
            ('moderation_status_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='moderatedphoto_moderated_objects', null=True, to=orm['auth.User'])),
        ...
        db.send_create_signal('posters', ['ModeratedPhoto'])


    def backwards(self, orm):
        
        # Deleting model 'ModeratedPhoto'
        db.delete_table('posters_moderatedphoto')
    ...
    models = {
        ...
        'posters.moderatedphoto': {
            'Meta': {'ordering': "['created_at', 'user']", 'object_name': 'ModeratedPhoto'},
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'moderation_status_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'moderatedphoto_moderated_objects'", 'null': 'True', 'to': "orm['auth.User']"}),
