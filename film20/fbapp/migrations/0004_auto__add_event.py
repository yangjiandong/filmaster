...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Event'
        db.create_table('fbapp_event', (
            ('contest_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['fbapp.Contest'], unique=True, primary_key=True)),
            ...
            ('start_description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('end_description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('fbapp', ['Event'])
