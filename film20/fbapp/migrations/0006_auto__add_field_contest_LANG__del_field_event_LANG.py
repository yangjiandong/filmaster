...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Contest.LANG'
        db.add_column('fbapp_contest', 'LANG', self.gf('django.db.models.fields.CharField')(default='pl', max_length=2), keep_default=False)
        ...
        db.delete_column('fbapp_event', 'LANG')

        # Removing M2M table for field tickets on 'Event'
        db.delete_table('fbapp_event_tickets')


    def backwards(self, orm):
        
        # Deleting field 'Contest.LANG'
        db.delete_column('fbapp_contest', 'LANG')

        # Removing M2M table for field tickets on 'Contest'
        db.delete_table('fbapp_contest_tickets')

        # Adding field 'Event.LANG'
        db.add_column('fbapp_event', 'LANG', self.gf('django.db.models.fields.CharField')(default='pl', max_length=2), keep_default=False)

        # Adding M2M table for field tickets on 'Event'
        db.create_table('fbapp_event_tickets', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('event', models.ForeignKey(orm['fbapp.event'], null=False)),
            ('tickets', models.ForeignKey(orm['fbapp.tickets'], null=False))
        ))
        db.create_unique('fbapp_event_tickets', ['event_id', 'tickets_id'])
