...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('fbapp_tickets', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('theater', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['showtimes.Channel'])),
            ('date', self.gf('django.db.models.fields.DateField')()),
            ('descr', self.gf('django.db.models.fields.CharField')(default='', max_length=128)),
            ('amount', self.gf('django.db.models.fields.IntegerField')(default=1)),
        ))
        db.send_create_signal('fbapp', ['Tickets'])

        # Adding model 'Contest'
        db.create_table('fbapp_contest', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(default='', max_length=128)),
            ('descr', self.gf('django.db.models.fields.TextField')(default='')),
            ('state', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('final_date', self.gf('django.db.models.fields.DateField')()),
        ))
        db.send_create_signal('fbapp', ['Contest'])

        # Adding model 'ContestParticipation'
        db.create_table('fbapp_contestparticipation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('contest', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fbapp.Contest'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('ticket', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fbapp.Tickets'])),
            ('score', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('state', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('fbapp', ['ContestParticipation'])


    def backwards(self, orm):
        
        # Deleting model 'Tickets'
        db.delete_table('fbapp_tickets')

        # Deleting model 'Contest'
        db.delete_table('fbapp_contest')

        # Deleting model 'ContestParticipation'
        db.delete_table('fbapp_contestparticipation')
    ...
    models = {
        ...
        'fbapp.contest': {
            ...
            'descr': ('django.db.models.fields.TextField', [], {'default': "''"}),
        ...
        'fbapp.tickets': {
            ...
            'descr': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '128'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
