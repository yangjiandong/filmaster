...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ContestTickets'
        db.create_table('fbapp_contesttickets', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('contest', self.gf('django.db.models.fields.related.ForeignKey')(related_name='tickets', to=orm['fbapp.Contest'])),
            ('theater', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['showtimes.Channel'])),
            ('descr', self.gf('django.db.models.fields.CharField')(max_length=128, blank=True)),
            ('amount', self.gf('django.db.models.fields.IntegerField')(default=1)),
        ))
        db.send_create_signal('fbapp', ['ContestTickets'])

        # Adding field 'ContestParticipation.ticket_new'
        db.add_column('fbapp_contestparticipation', 'contest_ticket', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fbapp.ContestTickets'], null=True, blank=True), keep_default=False)

        # Removing M2M table for field tickets on 'Contest'
        db.delete_table('fbapp_contest_tickets')

        for c in orm.Contest.objects.all():
            for t in c.tickets_old.all():
                ct = orm.ContestTickets.objects.create(contest=c, theater=t.theater, descr=t.descr, amount=t.amount)

    def backwards(self, orm):
        
        # Deleting model 'ContestTickets'
        db.delete_table('fbapp_contesttickets')

        # Deleting field 'ContestParticipation.ticket_new'
        db.delete_column('fbapp_contestparticipation', 'contest_ticket_id')

        # Adding M2M table for field tickets on 'Contest'
        db.create_table('fbapp_contest_tickets', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('contest', models.ForeignKey(orm['fbapp.contest'], null=False)),
            ('tickets', models.ForeignKey(orm['fbapp.tickets'], null=False))
        ))
        db.create_unique('fbapp_contest_tickets', ['contest_id', 'tickets_id'])
    ...
    models = {
        ...
        'fbapp.contest': {
            ...
            'Meta': {'ordering': "('-final_date',)", 'object_name': 'Contest'},
            'descr': ('django.db.models.fields.TextField', [], {'default': "''", 'blank': 'True'}),
            'final_date': ('django.db.models.fields.DateField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'state': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'tickets_old': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'tickets_old'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['fbapp.Tickets']"}),
        ...
        'fbapp.contestparticipation': {
            ...
            'ratings_start_count': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            ...
            'ticket_new': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['fbapp.ContestTickets']", 'null': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'wallpost_published': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        'fbapp.contesttickets': {
            'Meta': {'object_name': 'ContestTickets'},
            'amount': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
            'contest': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'tickets'", 'to': "orm['fbapp.Contest']"}),
        ...
        'fbapp.event': {
            ...
            'Meta': {'ordering': "('-final_date',)", 'object_name': 'Event', '_ormbases': ['fbapp.Contest']},
            ...
            'wallpost_description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'})
        },
        'fbapp.tickets': {
