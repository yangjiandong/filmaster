...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for cp in orm.ContestParticipation.objects.all():
            if cp.ticket:
                cp.contest_ticket = cp.contest.tickets.get(theater=cp.ticket.theater)
            cp.save()
    ...
    models = {
        ...
        'fbapp.contestparticipation': {
            ...
            'contest_ticket': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['fbapp.ContestTickets']", 'null': 'True', 'blank': 'True'}),
