...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ContestParticipation.is_active'
        db.add_column('fbapp_contestparticipation', 'is_active', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'ContestParticipation.created_at'
        db.add_column('fbapp_contestparticipation', 'created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ContestParticipation.is_active'
        db.delete_column('fbapp_contestparticipation', 'is_active')

        # Deleting field 'ContestParticipation.created_at'
        db.delete_column('fbapp_contestparticipation', 'created_at')
