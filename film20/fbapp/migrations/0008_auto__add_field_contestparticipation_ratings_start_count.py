...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ContestParticipation.ratings_start_count'
        db.add_column('fbapp_contestparticipation', 'ratings_start_count', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ContestParticipation.ratings_start_count'
        db.delete_column('fbapp_contestparticipation', 'ratings_start_count')
