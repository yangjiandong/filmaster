...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ContestParticipation.ticket'
        db.alter_column('fbapp_contestparticipation', 'ticket_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fbapp.Tickets'], null=True))


    def backwards(self, orm):
        
        # Changing field 'ContestParticipation.ticket'
        db.alter_column('fbapp_contestparticipation', 'ticket_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['fbapp.Tickets']))
