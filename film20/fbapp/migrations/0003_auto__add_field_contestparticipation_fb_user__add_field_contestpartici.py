...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ContestParticipation.fb_user'
        db.add_column('fbapp_contestparticipation', 'fb_user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['facebook_connect.FBUser'], null=True), keep_default=False)

        # Adding field 'ContestParticipation.wallpost_published'
        db.add_column('fbapp_contestparticipation', 'wallpost_published', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'ContestParticipation.sent_invite_count'
        db.add_column('fbapp_contestparticipation', 'sent_invite_count', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'ContestParticipation.accepted_invites_count'
        db.add_column('fbapp_contestparticipation', 'accepted_invites_count', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ContestParticipation.fb_user'
        db.delete_column('fbapp_contestparticipation', 'fb_user_id')

        # Deleting field 'ContestParticipation.wallpost_published'
        db.delete_column('fbapp_contestparticipation', 'wallpost_published')

        # Deleting field 'ContestParticipation.sent_invite_count'
        db.delete_column('fbapp_contestparticipation', 'sent_invite_count')

        # Deleting field 'ContestParticipation.accepted_invites_count'
        db.delete_column('fbapp_contestparticipation', 'accepted_invites_count')
