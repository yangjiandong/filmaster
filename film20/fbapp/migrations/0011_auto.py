...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field tickets_old on 'Contest'
        db.create_table('fbapp_contest_tickets_old', (
        ...
        db.create_unique('fbapp_contest_tickets_old', ['contest_id', 'tickets_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field tickets_old on 'Contest'
        db.delete_table('fbapp_contest_tickets_old')
