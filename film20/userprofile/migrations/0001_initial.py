...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Avatar'
        db.create_table('userprofile_avatar', (
        ...
        db.send_create_signal('userprofile', ['Avatar'])

        # Adding unique constraint on 'Avatar', fields ['user', 'valid']
        db.create_unique('userprofile_avatar', ['user_id', 'valid'])
    ...
    def backwards(self, orm):
        ...
        db.delete_unique('userprofile_avatar', ['user_id', 'valid'])

        # Deleting model 'Avatar'
        db.delete_table('userprofile_avatar')
