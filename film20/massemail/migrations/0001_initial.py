...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('massemail_massemail', (
            ...
            ('sent_failed', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('sent_correctly', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('sent_failed_to', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('sent_correctly_to', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('massemail', ['MassEmail'])


    def backwards(self, orm):
        
        # Deleting model 'MassEmail'
        db.delete_table('massemail_massemail')
    ...
    models = {
        ...
        'massemail.massemail': {
            'Meta': {'ordering': "['-created_at', 'subject']", 'object_name': 'MassEmail'},
            ...
            'sent_correctly': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'sent_correctly_to': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'sent_failed': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'sent_failed_to': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'subject': ('django.db.models.fields.CharField', [], {'max_length': '100'})
        }
    }

    complete_apps = ['massemail']
