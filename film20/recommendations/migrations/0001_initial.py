...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Computed'
        db.create_table('recommendations_computed', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('comparators', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('recommendations', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('recommendations', ['Computed'])


    def backwards(self, orm):
        
        # Deleting model 'Computed'
        db.delete_table('recommendations_computed')
