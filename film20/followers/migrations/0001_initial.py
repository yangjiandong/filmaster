...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Followers'
        db.create_table('followers_followers', (
        ...
        db.send_create_signal('followers', ['Followers'])

        # Adding unique constraint on 'Followers', fields ['from_user', 'to_user', 'status']
        db.create_unique('followers_followers', ['from_user_id', 'to_user_id', 'status'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Followers', fields ['from_user', 'to_user', 'status']
        db.delete_unique('followers_followers', ['from_user_id', 'to_user_id', 'status'])

        # Deleting model 'Followers'
        db.delete_table('followers_followers')
