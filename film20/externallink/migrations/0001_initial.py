...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('externallink_externallink', (
            ...
            ('moderation_status_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='externallink_moderated_objects', null=True, to=orm['auth.User'])),
            ...
            ('url_kind', self.gf('django.db.models.fields.IntegerField')(default=1)),
            ...
            ('film', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='film_link', null=True, to=orm['core.Film'])),
            ('person', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='person_link', null=True, to=orm['core.Person'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')()),
            ('LANG', self.gf('django.db.models.fields.CharField')(default='en', max_length=2)),
        ))
        db.send_create_signal('externallink', ['ExternalLink'])


    def backwards(self, orm):
        
        # Deleting model 'ExternalLink'
        db.delete_table('externallink_externallink')
