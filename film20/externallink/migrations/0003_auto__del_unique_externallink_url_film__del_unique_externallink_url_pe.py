...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        with transaction():
            # Removing unique constraint on 'ExternalLink', fields ['url', 'person']
            db.delete_unique('externallink_externallink', ['url', 'person_id'])

        with transaction():
            # Removing unique constraint on 'ExternalLink', fields ['url', 'film']
            db.delete_unique('externallink_externallink', ['url', 'film_id'])

        # Adding unique constraint on 'ExternalLink', fields ['url', 'LANG', 'film']
        db.create_unique('externallink_externallink', ['url', 'LANG', 'film_id'])

        db.create_unique('externallink_externallink', ['url', 'person_id', 'LANG'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'ExternalLink', fields ['url', 'person', 'LANG']
        db.delete_unique('externallink_externallink', ['url', 'person_id', 'LANG'])

        # Removing unique constraint on 'ExternalLink', fields ['url', 'LANG', 'film']
        db.delete_unique('externallink_externallink', ['url', 'LANG', 'film_id'])

        # Adding unique constraint on 'ExternalLink', fields ['url', 'film']
        # db.create_unique('externallink_externallink', ['url', 'film_id'])

        # Adding unique constraint on 'ExternalLink', fields ['url', 'person']
        # db.create_unique('externallink_externallink', ['url', 'person_id'])
