...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ExternalLinkToRemove'
        db.create_table('externallink_externallinktoremove', (
            ...
            ('moderation_status_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='externallinktoremove_moderated_objects', null=True, to=orm['auth.User'])),
            ('rejection_reason', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('externallink', self.gf('django.db.models.fields.related.ForeignKey')(related_name='remove_link', to=orm['externallink.ExternalLink'])),
        ))
        db.send_create_signal('externallink', ['ExternalLinkToRemove'])


    def backwards(self, orm):
        
        # Deleting model 'ExternalLinkToRemove'
        db.delete_table('externallink_externallinktoremove')
    ...
    models = {
        ...
        'externallink.externallinktoremove': {
            'Meta': {'object_name': 'ExternalLinkToRemove'},
            'externallink': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'remove_link'", 'to': "orm['externallink.ExternalLink']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'moderation_status': ('django.db.models.fields.IntegerField', [], {'default': '-1'}),
            'moderation_status_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'moderation_status_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'externallinktoremove_moderated_objects'", 'null': 'True', 'to': "orm['auth.User']"}),
            'rejection_reason': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        },
        'followers.followers': {
