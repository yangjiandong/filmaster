...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        orm.NoticeType.objects.create(label='import_ratings_log', display='Import ratings Log', description='Films have been rated', default=2, type=0)

    def backwards(self, orm):
        import_ratings_log = orm.NoticeType.objects.get(label='import_ratings_log')
        import_ratings_log.delete()
