...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'NoticeType.user_group'
        db.add_column('notification_noticetype', 'user_group', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'NoticeType.user_group'
        db.delete_column('notification_noticetype', 'user_group')
    ...
    models = {
        ...
        'notification.noticetype': {
            ...
            'user_group': ('django.db.models.fields.IntegerField', [], {'default': '0'})
        },
