...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'NoticeType.hidden'
        db.add_column('notification_noticetype', 'hidden', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'NoticeType.hidden'
        db.delete_column('notification_noticetype', 'hidden')
