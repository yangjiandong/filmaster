...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Demot.LANG'
        db.add_column('demots_demot', 'LANG', self.gf('django.db.models.fields.CharField')(default='pl', max_length=2), keep_default=False)

        # Adding unique constraint on 'Demot', fields ['LANG', 'user', 'line1', 'line2']
        db.create_unique('demots_demot', ['LANG', 'user_id', 'line1', 'line2'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Demot', fields ['LANG', 'user', 'line1', 'line2']
        db.delete_unique('demots_demot', ['LANG', 'user_id', 'line1', 'line2'])

        # Deleting field 'Demot.LANG'
        db.delete_column('demots_demot', 'LANG')
