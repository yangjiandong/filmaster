...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Demot'
        db.create_table('demots_demot', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('line1', self.gf('django.db.models.fields.CharField')(max_length=150)),
            ...
            ('final_image', self.gf('django.db.models.fields.files.ImageField')(max_length=255, null=True, blank=True)),
        ))
        db.send_create_signal('demots', ['Demot'])


    def backwards(self, orm):
        
        # Deleting model 'Demot'
        db.delete_table('demots_demot')
