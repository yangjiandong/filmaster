...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Demot.based_on'
        db.add_column('demots_demot', 'based_on', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['demots.Demot'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Demot.based_on'
        db.delete_column('demots_demot', 'based_on_id')
