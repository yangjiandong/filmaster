...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'AddedFilm'
        db.create_table('add_films_addedfilm', (
            ...
            ('moderation_status_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='addedfilm_moderated_objects', null=True, to=orm['auth.User'])),
        ...
        db.send_create_signal('add_films', ['AddedFilm'])

        # Adding M2M table for field directors on 'AddedFilm'
        db.create_table('add_films_addedfilm_directors', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('addedfilm', models.ForeignKey(orm['add_films.addedfilm'], null=False)),
            ('person', models.ForeignKey(orm['core.person'], null=False))
        ))
        db.create_unique('add_films_addedfilm_directors', ['addedfilm_id', 'person_id'])

        # Adding M2M table for field production_country on 'AddedFilm'
        db.create_table('add_films_addedfilm_production_country', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('addedfilm', models.ForeignKey(orm['add_films.addedfilm'], null=False)),
            ('country', models.ForeignKey(orm['core.country'], null=False))
        ))
        db.create_unique('add_films_addedfilm_production_country', ['addedfilm_id', 'country_id'])

        # Adding model 'AddedCharacter'
        db.create_table('add_films_addedcharacter', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('person', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Person'])),
            ('added_film', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['add_films.AddedFilm'])),
        ...
        db.send_create_signal('add_films', ['AddedCharacter'])


    def backwards(self, orm):
        
        # Deleting model 'AddedFilm'
        db.delete_table('add_films_addedfilm')

        # Removing M2M table for field directors on 'AddedFilm'
        db.delete_table('add_films_addedfilm_directors')

        # Removing M2M table for field production_country on 'AddedFilm'
        db.delete_table('add_films_addedfilm_production_country')

        # Deleting model 'AddedCharacter'
        db.delete_table('add_films_addedcharacter')


    models = {
        'add_films.addedcharacter': {
            'Meta': {'object_name': 'AddedCharacter'},
            'added_film': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['add_films.AddedFilm']"}),
        ...
        'add_films.addedfilm': {
            'Meta': {'ordering': "['created_at', 'user']", 'object_name': 'AddedFilm'},
            'actors': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'added_films_played'", 'to': "orm['core.Person']", 'through': "orm['add_films.AddedCharacter']", 'blank': 'True', 'symmetrical': 'False', 'null': 'True'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'directors': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'added_films_directed'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['core.Person']"}),
            ...
            'moderation_status_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'addedfilm_moderated_objects'", 'null': 'True', 'to': "orm['auth.User']"}),
            'production_country': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'add_films_produced_in'", 'symmetrical': 'False', 'to': "orm['core.Country']"}),
