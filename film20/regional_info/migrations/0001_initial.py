...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'RegionalInfo'
        db.create_table('regional_info_regionalinfo', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='regional_info_editor', to=orm['auth.User'])),
        ...
        db.send_create_signal('regional_info', ['RegionalInfo'])


    def backwards(self, orm):
        
        # Deleting model 'RegionalInfo'
        db.delete_table('regional_info_regionalinfo')
    ...
    models = {
        ...
        'regional_info.regionalinfo': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'regional_info_editor'", 'to': "orm['auth.User']"})
        }
    }

    complete_apps = ['regional_info']
